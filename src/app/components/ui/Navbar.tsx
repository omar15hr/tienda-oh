...
export default function Navbar() {
  ...
  const navigation = [
    ...
    { title: "Hombres", path: "javascript:void(0)", isDrapdown: false },
    { title: "Niños", path: "javascript:void(0)", isDrapdown: false },
    { title: "Explora", path: "javascript:void(0)", isDrapdown: false },
  ];
          ...
          >
            <ul className="items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
              ...
              <div className="flex-1 items-center justify-end gap-x-6 space-y-3 md:flex md:space-y-0">
                <form className="flex items-center space-x-2 border p-2">
                  <SearchIcon />
                  <input
